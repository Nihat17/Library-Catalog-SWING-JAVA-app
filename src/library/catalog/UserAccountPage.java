...
public class UserAccountPage extends javax.swing.JFrame {
    ...
    public UserAccountPage(User user) {
        ...
        setFont();         
        fillUserDetails();
        getAndSetTakenBooksToTable();
    }

    private void getAndSetTakenBooksToTable() {
        try {
            List listOfBooks = retObj.selectBooks(Integer.parseInt(idField.getText()));
            retObj.setBookTable(bookDetailsTable, listOfBooks);
    ...
    private void initComponents() {
        ...
        bookDetailsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ISBN", "Title", "Author", "Genre", "Edition", "Publication Year", "DueDate"
            }
        ) {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
       ...
       if(!titleField.getText().isEmpty() && !authorField.getText().isEmpty()){            
            menu = new SearchResult(this, true, titleField.getText(), 
                   authorField.getText(), userID);
            menu.setVisible(true);
            List detailList = menu.getListForTable();
            if(!detailList.isEmpty())
                retObj.setBookTable(bookDetailsTable, detailList); 
       }
       else{
